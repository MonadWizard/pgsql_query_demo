...
CREATE TABLE ordersnew (
  id SERIAL PRIMARY KEY,
  user_id INTEGER REFERENCES usersnew(id),
  product_id INTEGER REFERENCES productsnew(id),
  paid BOOLEAN
);


INSERT INTO usersnew (first_name, last_name) 
VALUES 
  ('Iva', 'Lindgren'),
	('Ignatius', 'Johns'),
	('Jannie', 'Boehm'),
...
INSERT INTO productsnew (name, department, price, weight)
VALUES
...
INSERT INTO ordersnew (user_id, product_id, paid)
VALUES
  (41, 100, true),
	(27, 99, false),
	(50, 72, false),
